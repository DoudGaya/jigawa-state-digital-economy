...
import { updateAcademic } from '@/actions/academics-management'
...
interface EditAcademicFormProps {
  academic: AcademicType;
  onSubmit: (academic: AcademicType) => void;
  onClose: () => void;
}

export function EditAcademicForm({ academic, onSubmit, onClose }: EditAcademicFormProps) {
  ...
  const form = useForm<z.infer<typeof AcademicSchema>>({
    ...
    defaultValues: {
      ...
      otherName: academic.otherName || '',
      email: academic.email,
      institution: academic.institution,
      sex: academic.sex as "Male" | "Female" | "Other",
      lga: academic.lga,
      discipline: academic.discipline,
      teachingExperience: academic.teachingExperience,
      rank: academic.rank,
      whatsappNo: academic.whatsappNo,
    },
  })
  ...
  async function handleSubmit(values: z.infer<typeof AcademicSchema>) {
    ...
    try {
      const result = await updateAcademic(academic.id, values)
