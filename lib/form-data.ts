export const disciplines = [
  ...
  { value: "biology-education", label: "Biology Education" },
  ...
  { value: "criminology-security-studies", label: "Criminology and Security Studies" },
  ...
  { value: "education-biology", label: "Education and Biology" },
  { value: "education-chemistry", label: "Education and Chemistry" },
  { value: "education-english", label: "Education and English" },
  { value: "education-mathematics", label: "Education and Mathematics" },
  ...
  { value: "fine-applied-arts", label: "Fine and Applied Arts" },
  { value: "fisheries", label: "Fisheries" },
  { value: "food-science-technology", label: "Food Science and Technology" },
  { value: "forestry", label: "Forestry" },
  { value: "geography", label: "Geography" },
  { value: "geology", label: "Geology" },
  { value: "guidance-counselling", label: "Guidance and Counselling" },
  { value: "history-international-studies", label: "History and International Studies" },
  { value: "human-nutrition-dietetics", label: "Human Nutrition and Dietetics" },
  { value: "human-resource-management", label: "Human Resource Management" },
  { value: "information-systems", label: "Information Systems" },
  { value: "information-technology", label: "Information Technology" },
  { value: "insurance", label: "Insurance" },
  { value: "international-relations", label: "International Relations" },
  { value: "law", label: "Law (LL.B)" },
  ...
  { value: "medicine-surgery", label: "Medicine and Surgery" },
  { value: "microbiology", label: "Microbiology" },
  { value: "music", label: "Music" },
  { value: "nursing-science", label: "Nursing Science" },
  { value: "performing-arts", label: "Performing Arts/Theatre Arts" },
  ...
  { value: "urban-regional-planning", label: "Urban and Regional Planning" },
...
export const jigawaStateLGAs = ["Auyo", "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", "Kazaure", "Kiri Kasama", "Kiyawa", "Kaugama", "Maigatari", "Malam Madori", "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"]